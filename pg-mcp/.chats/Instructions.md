...
### 查阅整理 codex review 文档

请查阅下 @/specs/0005-pg-mcp-impl-plan-review.md 和 @/specs/0006-pg-mcp-code-review.md 请将其分别整理成中文文档，放在 @/specs 目录下。另外，将这两份原始文档放在 @/source-specs 目录下。

### 构建详细设计文档

请先整体查看下项目，现在需要在 @/specs/pg-mcp-代码评审报告.md 的基础上，针对代码质量问题这块，做一个详细设计，生成文档 0009-pg-mcp-codex-review-design.md。

缺失组件部分一起进行详细设计。

### 实现

阅读 @/specs/0009-pg-mcp-codex-review-design.md，完成 phase 1 到 phase 2 的开发实现。
阅读 @/specs/0009-pg-mcp-codex-review-design.md，完成 phase 3 到 phase 5 的开发实现。
继续完成 phse 6 的开发实现。

### 整理文档

针对目前的项目结构，整体整理下项目中的 @/specs 下文档，另外，重新梳理下 @/README.md。
